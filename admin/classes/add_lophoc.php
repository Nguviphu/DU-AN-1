                    ...
                    <div class="card-body">
                        <form action="#" method="POST" id="add_khoahoc">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="teacher" id="" class="form-control">
                                    ...
                                    foreach ($teacher as $item) {
                                        extract($item);
                                        if ($role == 2) {
                                            echo '<option value="' . $full_name . '" class="form-control">' . $full_name . '</option>';
                                        }
                                    }
                                    ?>
                            ...
                            <div class="mb-3 text-center">
                                ...
                                <input type="submit" name="btn_add_class" value="Tạo lớp" class="btn btn-primary mr-3" />
                                <a href="index.php?ctrl=list_lophoc"><input type="button" class="btn btn-success" value="Danh sách" /></a>
                            </div>
                        </form>
                    </div>
                </div>
