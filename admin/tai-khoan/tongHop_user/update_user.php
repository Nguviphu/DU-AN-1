<?php
if (is_array($load_one_user)) {
    extract($load_one_user);
}
?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="index.php?ctrl=update_user" method="POST" id="add_khoahoc">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="role" class="form-control" value="<?php if (isset($role) && ($role != "")) echo $role; ?>" />
                            </div>
                            ...
                            <div class="mb-3 text-center">
                                ...
                                <input type="submit" name="btn_update_user" value="Cập Nhật" class="btn btn-primary mr-3" />
