<?php
if (is_array($load_one_student)) {
    extract($load_one_student);
}
?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="index.php?ctrl=update_student" method="POST" id="add_khoahoc">
                            <div class="mb-3">
                            ...
                            <div class="mb-3 text-center">
                                ...
                                <input type="submit" name="btn_update_student" value="Cập Nhật" class="btn btn-primary mr-3" />
