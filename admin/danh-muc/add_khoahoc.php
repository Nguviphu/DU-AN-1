                    ...
                    <div class="card-body">
                        <form action="#" method="POST" id="add_khoahoc">
                            ...
                            <div class="mb-3 text-center">
                                ...
                                <input type="submit" name="btn_add_subjects" value="Thêm mới" class="btn btn-primary mr-3" />
                                <a href="index.php?ctrl=list_subjects"><input type="button" class="btn btn-success" value="Danh sách" /></a>
                            </div>
                        </form>
                    </div>
                </div>
